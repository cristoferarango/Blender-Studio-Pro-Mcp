bl_info = {
    ...
    "author": "Cristofer Arango (corporacionarango.com)",
    "version": (2, 0, 0),
    "blender": (3, 6, 0),
    "location": "View3D > Sidebar > Studio Pro",
    "description": "100% Blender control from any MCP client (Cursor, Claude, Codex, OpenCode, DeepSeek). Apache-2.0, no license key.",
    "doc_url": "https://corporacionarango.com",
    "tracker_url": "https://corporacionarango.com",
    "category": "Interface",
}
...
class BMPRO_PT_MainPanel(bpy.types.Panel):
    bl_label = "Blender Studio Pro MCP"
    bl_idname = "BMPRO_PT_main"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Studio Pro"
    ...
    def draw(self, context):
        ...
        layout.separator()
        layout.label(text="100% Blender via MCP")
        layout.label(text="Cristofer Arango")
        layout.label(text="corporacionarango.com")
...
class BMPRO_OT_StartServer(bpy.types.Operator):
    ...
    bl_label = "Start Studio Pro MCP Server"
    bl_description = "Start the Blender Studio Pro MCP TCP server"
...
class BMPRO_OT_StopServer(bpy.types.Operator):
    ...
    bl_label = "Stop Studio Pro MCP Server"
    bl_description = "Stop the Blender Studio Pro MCP TCP server"
